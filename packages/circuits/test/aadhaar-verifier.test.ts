...
async function prepareTestData() {
  ...
  const updateTemplate = [
    ...
    "13483382060079230067188057675928039600565406666878111320562435194759310415773", "1766523189000000000", // expirationDate
...
describe('AadhaarVerifier', function () {
  ...
  it('should output extracted data if reveal is true', async () => {
    ...
    assert(witness[3] === BigInt("17197379554625536703947581674092063580281968002775744774421564257161394884870"));
    // compare the results with the results of the go-core library
    assert(witness[4] === BigInt("19269793743551803401051824834171531484782280098082249209980919774446226003735"));
