...
describe('AadhaarVerifier', function () {
  ...
  it('should output extracted data if reveal is true', async () => {
    ...
    */
    ...
    assert(witness[3] === BigInt("6018719850352013939265849176758871995092950971991073040826531371311440243608"));
    ...
    assert(witness[9] === BigInt("14149879796206791333563169556410597478578550553387267777788958542524526020437"));
    // compare issuer
