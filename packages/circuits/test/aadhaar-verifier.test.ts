...
describe('AadhaarVerifier', function () {
  ...
  it('should output extracted data if reveal is true', async () => {
    ...
    assert(witness[4] === BigInt("16890017624039144676232207799246105570874701447257425357355660902379658316851"));
    assert(witness[5] === BigInt("3673141611637303612891330806851320518035338013474283360361546925486435373793"));
  })
})
