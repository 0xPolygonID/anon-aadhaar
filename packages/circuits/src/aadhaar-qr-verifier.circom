...
template AadhaarQRVerifier(n, k, maxDataLength, nLevels, smtChanges) {
    ...
    var keysToUpdate[smtChanges] = [
        5751456127448789510753404233713421746509146527908451401686655956477345583635, // birthday
        3318836932409460099840304752914646245037097428784473403764289798361397294255, // gender
        20577136056191360560289490021789537473272434498034348384300827512091609823990, // pinCode
        8897442514034904468148561732177026445541775910914709988947147524594211398012, // state
        869216178287292699550451791460637249489035896174352372440663007714837671007, // name
        629149548010222773287542412947332202352013141523866783940682428978496104020, // referenceID
        14512998077526793570215082115945432260584365246820264616091924527413647500183, // house
        14748159073270928381473439027869493053063595361404463415882317897916125902790, // street
        18840556411590488415073972212467374833678687425146622931052947953548116845838, // VTC
        4809288208205333239044399615082832123737089579183363178842081905807314191006, // district
    ...
    */
    ...
    var valuesToUpdate[smtChanges] = [
        ...
        qrDataExtractor.referenceID,
        qrDataExtractor.house,
        qrDataExtractor.street,
        qrDataExtractor.VTC,
        qrDataExtractor.district,
    ...
    var i0 = 14479598246615110828633522815890499012902;
